      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        >
          <p className="text-lg text-center md:text-xl text-text-secondary leading-relaxed font-light">
            ...
            I'm Rohit, an AI/ML Engineer and UI/UX Designer passionate about turning ideas into intelligent, user-friendly experiences. With a deep curiosity for Artificial Intelligence and modern design, I enjoy building smart solutions that are both innovative and impactful. I'm always eager to learn, experiment with new technologies, and create products that make a meaningful difference.

          </p>
        </motion.div>

        <h1 className="text-2xl font-bold text-accent-1 mb-10 font-mono flex items-center">
          <span className="mr-4 text-3xl"> <h1>Education History</h1></span>
        </h1>
